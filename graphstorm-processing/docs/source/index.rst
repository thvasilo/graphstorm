...
To quickly get started with the library for local testing
you can pip-install it using:

.. code-block:: bash

  pip install graphstorm-processing

Otherwise, installing the library from source is straightforward:
