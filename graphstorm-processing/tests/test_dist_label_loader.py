...
def test_dist_classification_label(spark: SparkSession, input_df: DataFrame, check_df_schema):
    ...
    assert set(label_map.keys()) == {"mark", "john", "tara", "kate", "jen"}
    ...
    # We expect 5 distinct int label values as each element is unique
