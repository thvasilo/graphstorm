""" Distributed partitioning entry point
"""
...
from s3_utils import download_data_from_s3, upload_file_to_s3 # pylint: disable=wrong-import-order
from partition_algorithm import RandomPartitioner, METISPartitioner, PartitionConfig, METISConfig # pylint: disable=wrong-import-order
...
def main():
    ...
    if args.partition_algorithm == 'random':
        ...
        raise RuntimeError(f"Unknown partition algorithm {args.partition_algorithm}")
